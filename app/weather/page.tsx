...
export default function WeatherPage() {
  return (
    <div>
      <PageHero eyebrow="Tool" title="Weather snapshot" description="Public API demo with visible network dependency and graceful failure handling." actions={<Link href="https://open-meteo.com/" className="rounded-xl border border-slate-700 px-5 py-3 font-semibold text-slate-200 hover:border-red-400 hover:text-red-300">Open-Meteo</Link>} />
