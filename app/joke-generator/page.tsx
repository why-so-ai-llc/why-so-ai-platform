...
export default function JokeGeneratorPage() {
  return (
    <div>
      <PageHero eyebrow="Tool" title="Joke generator" description="Public API demo with request timeout and explicit error feedback." actions={<Link href="https://official-joke-api.appspot.com/" className="rounded-xl border border-slate-700 px-5 py-3 font-semibold text-slate-200 hover:border-red-400 hover:text-red-300">Official Joke API</Link>} />
